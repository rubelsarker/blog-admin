                ...
                <form class="form-horizontal" action="{{route('admin.posts.update',$post->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input value="{{$post->title}}" type="text" name="title" class="form-control" id="name" placeholder="Title">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="sub_title" class="col-sm-2 control-label">Sub Title</label>
                            <div class="col-sm-10">
                                <input value="{{$post->sub_title}}" type="text" name="sub_title" class="form-control" id="sub_title" placeholder=" Sub Title">
                            </div>
                        </div>
                        <div class="form-group">
